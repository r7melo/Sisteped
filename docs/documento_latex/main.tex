...
A equipe de desenvolvimento foi estruturada nas seguintes camadas de atuação:

\begin{itemize}
    \item \textbf{Engenharia de Requisitos:}
    \begin{itemize}
        \item Antonio Romario Carlos de Melo
        \item Klenisson Mateus Oliveira Ribeiro
    \end{itemize}

    \item \textbf{Prototipação (UI/UX):}
    \begin{itemize}
        \item Francisco Diego Targino Sabino
        \item José Emanoel Alves Madureira
    \end{itemize}

    \item \textbf{Desenvolvimento Front-End:}
    \begin{itemize}
        \item André Luis Felício da Silva
        \item Francisco Diego Targino Sabino
        \item Klenisson Mateus Oliveira Ribeiro
    \end{itemize}
